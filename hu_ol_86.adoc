...
具有ONTAP版本的Oracle Linux 8.6没有已知问题。


NOTE: 有关Oracle Linux (Red Hat兼容内核)的已知问题、请参见link:hu_rhel_86.html#known-problems-and-limitations["已知问题"]相应Red Hat Enterprise Linux发行说明文件中的一节。
