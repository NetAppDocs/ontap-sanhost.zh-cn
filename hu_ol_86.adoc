...
NOTE: 要配置Oracle Linux 8.6 Red Hat兼容内核(RHCK)、请使用适用于Red Hat Enterprise Linux (RHEL) 8.6的link:hu_rhel_86.html#recommended-settings["建议设置"]。
...
NOTE: 有关Oracle Linux RHCK已知问题、请参见link:hu_rhel_86.html#known-problems-and-limitations["已知问题"]相应Red Hat Enterprise Linux发行说明文件中的一节。
