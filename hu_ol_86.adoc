...
---
= 将Oracle Linux 8.6与NetApp ONTAP 结合使用
:toc: macro
:hardbreaks:
:toclevels: 1P
:allow-uri-read: 
...
NOTE: 要配置Oracle Linux 8.6 RedHat Enterprise Kernel (RHCK)、请使用 link:hu_rhel_86.html#recommended-settings["建议设置"] 适用于Red Hat Enterprise Linux (RHEL) 8.6。
