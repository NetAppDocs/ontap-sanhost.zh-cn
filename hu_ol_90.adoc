...
以下各节提供了映射到ASA和非ASA用户身份的LUN的多路径输出示例。
...
NOTE: 要配置Oracle Linux 9.0 Red Hat兼容内核(RHCK)、请使用适用于Red Hat Enterprise Linux (RHEL) 9.0的link:hu_rhel_86.html#recommended-settings["建议设置"]。
