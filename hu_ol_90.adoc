...
[role="lead"]
您可以使用ONTAP SAN主机配置设置将使用ONTAP的Oracle Linux 9.0配置为目标。
...
NOTE: 要配置Oracle Linux 9.0 Red Hat Enterprise Kernel (RHCK)、请使用link:hu_rhel_86.html#recommended-settings["建议设置"]适用于Red Hat Enterprise Linux (RHEL) 9.0的。
...
Oracle Linux 9.0 with NetApp ONTAP发行版存在以下已知问题：
