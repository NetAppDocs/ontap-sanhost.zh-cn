...
.您需要的内容
上提供了 NetApp Linux Unified Host Utilities 软件包 link:https://mysupport.netapp.com/site/["NetApp 支持站点"^] 在 32 位或 64 位 .rpm 文件中。
...
. 从下载 32 位或 64 位 Linux Unified Host Utilities 软件包 link:https://mysupport.netapp.com/site/["NetApp 支持站点"^] 主机。
