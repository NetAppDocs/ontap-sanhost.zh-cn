...
---
= 将 VMware vSphere 7.x 与 NetApp ONTAP 结合使用
:toc: macro
:hardbreaks:
:toclevels: 1
:toc: 
...
本文档提供了有关采用 FC ， FCoE 和 iSCSI 协议的 vSphere 7.x 版本的 ONTAP SAN 主机配置设置的指导。
...
* link:https://www.netapp.com/media/13550-tr4597.pdf["TR-4597 ：采用 ONTAP 的 VMware vSphere"^]
