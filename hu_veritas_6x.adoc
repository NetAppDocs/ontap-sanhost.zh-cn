...
[role="lead"]
您可以对采用FC、FCoE和iSCSI协议的Red Hat Enterprise Linux和Oracle Linux (基于Red Hat兼容内核)平台的Veritas Storage Foundation 6系列使用ONTAP SAN主机配置设置。
...
您必须验证您的配置是否满足系统要求。有关详细信息、请参见 https://imt.netapp.com/matrix/#welcome["互操作性表工具"^]和Veritas HCL表。
