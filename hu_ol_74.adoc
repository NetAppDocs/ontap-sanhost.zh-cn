...
NOTE: 要配置Oracle Linux 7.4 Red Hat兼容内核(RHCK)、请使用适用于Red Hat Enterprise Linux (RHEL) 7.4的link:hu_rhel_74.html#recommended-settings["建议设置"]。
...
带有ONTAP的Oracle Linux 7.4版本存在以下已知问题：
