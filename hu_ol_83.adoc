...
NOTE: 要配置Oracle Linux 8.3 Red Hat Enterprise Kernel (RHCK)、请使用link:hu_rhel_83.html#recommended-settings["建议设置"]适用于Red Hat Enterprise Linux (RHEL) 8.3的。



== 已知问题

具有ONTAP版本的Oracle Linux 8.3没有已知问题。


NOTE: 有关Oracle Linux (Red Hat兼容内核)的已知问题、请参见link:hu_rhel_83.html#known-problems-and-limitations["已知问题"]相应Red Hat Enterprise Linux发行说明文件中的一节。
