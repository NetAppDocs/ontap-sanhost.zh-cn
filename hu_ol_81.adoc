...
NOTE: 要配置Oracle Linux 8.1 Red Hat Enterprise Kernel (RHCK)、请使用link:hu_rhel_81.html#recommended-settings["建议设置"]适用于Red Hat Enterprise Linux (RHEL) 8.1的。



== 已知问题

Oracle Linux 8.1 with ONTAP版本没有已知问题。


NOTE: 有关 Oracle Linux （ Red Hat 兼容内核）的已知问题，请参见 link:hu_rhel_81.html#known-problems-and-limitations["已知问题"] 适用于 Red Hat Enterprise Linux （ RHEL ） 8.1 。
