...
NOTE: 要配置Oracle Linux 8.8 Red Hat Enterprise Kernel、请使用link:hu_rhel_88.html#recommended-settings["建议设置"]适用于Red Hat Enterprise Linux (RHEL) 8.8的。
...
对于Oracle Linux 8.8及ONTAP版本、没有已知问题。
