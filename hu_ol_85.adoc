...
NOTE: 要配置Oracle Linux 8.5 Red Hat兼容内核(RHCK)、请使用适用于Red Hat Enterprise Linux (RHEL) 8.5的link:hu_rhel_85.html#recommended-settings["建议设置"]。
...
NOTE: 有关Oracle Linux RHCK已知问题、请参见link:hu_rhel_85.html#known-problems-and-limitations["已知问题"]相应RHEL版本文档中的一节。
