...
[role="lead"]
您可以使用ONTAP SAN主机配置设置将使用ONTAP的Oracle Linux 8.5配置为目标。
...
NOTE: 要配置Oracle Linux 8.5 Red Hat Enterprise Kernel (RHCK)、请使用link:hu_rhel_85.html#recommended-settings["建议设置"]适用于Red Hat Enterprise Linux (RHEL) 8.5的。
...
Oracle Linux 8.5 with ONTAP发行版没有已知问题。
