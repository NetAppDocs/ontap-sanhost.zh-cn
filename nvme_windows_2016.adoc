...
summary: 适用于采用 ONTAP 的 Windows Server 2016 的 NVMe/FC 主机配置 
---
= 适用于采用 ONTAP 的 Windows Server 2016 的 NVMe/FC 主机配置
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
您可以使用ONTAP作为目标在运行Windows Server 2016的主机上配置基于光纤通道的NVMe (NVMe/FC)。

适用于 Windows Server 2016 的 ONTAP 9.7 或更高版本支持 NVMe/FC 。
