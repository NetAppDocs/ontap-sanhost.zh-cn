...
NOTE: 要配置Oracle Linux 6.10 Red Hat兼容内核(RHCK)、请使用适用于Red Hat Enterprise Linux (RHEL) 6.10的link:hu_rhel_610.html#recommended-settings["建议设置"]。
...
NOTE: 有关Oracle Linux RHCK已知问题、请参见link:hu_rhel_610.html#known-problems-and-limitations["已知问题"]适用于RHEL 6.10的。
