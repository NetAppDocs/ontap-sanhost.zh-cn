...
具有ONTAP版本的Oracle Linux 8.2没有已知问题。


NOTE: 有关Oracle Linux (Red Hat兼容内核)的已知问题、请参见link:hu_rhel_82.html#known-problems-and-limitations["已知问题"]适用于Red Hat Enterprise Linux (RHEL) 8.2的。
