...
summary: '您可以使用"AIX主机实用程序"示例命令参考使用"主机实用程序"工具对NetApp存储配置进行端到端验证。' 
---
= 使用 AIX Host Utilities 命令验证ONTAP存储配置
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
您可以使用"AIX主机实用程序"示例命令参考使用"主机实用程序"工具对NetApp存储配置进行端到端验证。
...
.7.0 和 6.1
--
.显示 AIX Host Utilities 7.0 和 6.1 的示例
[%collapsible]
=====
[listing]
----
