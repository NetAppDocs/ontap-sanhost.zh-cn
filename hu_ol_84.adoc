...
[role="lead"]
您可以使用ONTAP SAN主机配置设置将以ONTAP为目标的Oracle Linux 8.4配置为目标。
...
NOTE: 要配置Oracle Linux 8.4 Red Hat Enterprise Kernel (RHCK)、请使用link:hu_rhel_84.html#recommended-settings["建议设置"]适用于Red Hat Enterprise Linux (RHEL) 8.4的。
...
Oracle Linux 8.4 with ONTAP发行版没有已知问题。
