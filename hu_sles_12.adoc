...
| link:https://mysupport.netapp.com/NOW/cgi-bin/bol?Type=Detail&Display=847490["84749"^] | 多路径守护进程显示了 SLES 12 上的路径故障 | 在存储或网络结构发生 I/O 故障期间，您可能会发现 SLES12 多路径守护进程上的路径故障。 
|===