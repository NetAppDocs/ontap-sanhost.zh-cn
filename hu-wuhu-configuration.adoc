...
[NOTE]
====
安装 Windows Host Utilities 7.2 后，需要更改 LimTransferSize 参数值。请参阅 <<parameter-72,NVME 参数>>。
...
[[parameter-72]]Windows Host Utilities 安装程序会根据您在安装过程中所做的选择，自动设置 Windows 注册表值以及 iSCSI 和 NVMe HBA 参数。查看这些值和操作系统版本。
