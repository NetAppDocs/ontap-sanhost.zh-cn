...
---
= 将 Oracle Linux 6.9 与 NetApp ONTAP 结合使用
:toc: macro
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
...
.您需要的内容
如果您决定使用 SAN 启动，则配置必须支持它。您可以使用 https://mysupport.netapp.com/matrix/imt.jsp?components=78284;78283;&solution=1&isHWU&src=IMT["NetApp 互操作性表工具"^] 验证您的操作系统， HBA ， HBA 固件和 HBA 启动 BIOS 以及 ONTAP 版本是否受支持。
...
NOTE: 要配置 Oracle Linux 6.9 RedHat Enterprise Kernel （ RHCK ），请使用 link:hu_rhel_69.html#recommended-settings["建议设置"] 适用于 Red Hat Enterprise Linux （ RHEL ） 6.9 。
