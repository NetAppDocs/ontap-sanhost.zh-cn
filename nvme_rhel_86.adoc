...
.步骤
. 在服务器上安装RHEL 8.6。安装完成后，验证您是否正在运行指定的 RHEL 8.6 内核。有关最新的受支持版本列表、请参见link:https://mysupport.netapp.com/matrix/["互操作性表工具"^]。
. 安装完成后，验证您是否正在运行指定的 RHEL 8.6 内核。有关最新的受支持版本列表、请参见link:https://mysupport.netapp.com/matrix/["互操作性表工具"^]。
+
示例
