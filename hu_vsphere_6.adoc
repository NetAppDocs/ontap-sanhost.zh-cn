...
有关配置和管理 VVOL 的详细信息，请参见适用于 VMware vSphere 的 ONTAP 工具文档以及 link:https://docs.netapp.com/us-en/netapp-solutions/hybrid-cloud/vsphere_ontap_ontap_for_vsphere.html["TR-4597"] 和 
...
* 要使用 ONTAP 访问 TR-4597- VMware vSphere ，请参见 link:https://cert.vmware.com/caas/support/case/00088028["客户案例 -00088028"] 和 
