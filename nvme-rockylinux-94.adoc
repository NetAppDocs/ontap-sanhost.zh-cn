...
了解如何为 Rocky Linux 9.4 配置 NVMe over Fabrics (NVMe-oF) 主机。如需更多支持和功能信息，请参阅 link:nvme-rockylinux-supported-features.html["Rocky Linux ONTAP支持和功能"]。

带有 Rocky Linux 9.4 的 NVMe-oF 没有已知的限制。
