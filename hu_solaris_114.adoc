...
您可以从下载包含 Host Utilities 软件包的压缩文件 https://mysupport.netapp.com/site/products/all/details/hostutilities/downloads-tab/download/61343/6.2/downloads["NetApp 支持站点"^]。获得该文件后、您必须对其进行解压缩、以获取安装Host Utilities所需的软件包。
