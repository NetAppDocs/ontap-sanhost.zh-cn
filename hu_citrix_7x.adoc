...
---
= 将 Citrix XenServer 与 NetApp ONTAP 结合使用
:toc: macro
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
...
本文档提供了有关使用 FC ， FCoE 和 iSCSI 协议的 Citrix XenServer 7 系列操作系统版本的 ONTAP SAN 主机配置设置的指导。
...
在本示例中，对于 Citrix XenServer 7.x ， `sda` 是黑名单中所需的本地 SCSI 磁盘。
