...
---
= 将 Red Hat Enterprise Linux 8.2 与 NetApp ONTAP 结合使用
:toc: macro
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
...
对于 Red Hat Enterprise Linux （ RHEL ） 8.2 ， /etc/multipath.conf 文件必须存在，但您不需要对该文件进行特定更改。RHEL 8.2 使用识别和正确管理 ONTAP LUN 所需的所有设置进行编译。
