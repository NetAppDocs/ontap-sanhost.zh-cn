...
NOTE: 要配置Oracle Linux 6.6 Red Hat兼容内核(RHCK)、请使用link:hu_rhel_66.html#recommended-settings["建议设置"]适用于Red Hat Enterprise Linux (RHEL) 6.6的。
...
NOTE: 有关Oracle Linux RHCK已知问题、请参见link:hu_rhel_66.html#known-problems-and-limitations["已知问题"]适用于RHEL 6.6的。
