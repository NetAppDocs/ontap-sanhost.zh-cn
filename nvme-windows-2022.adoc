...
summary: '您可以在运行Windows Server 2022的主机上配置基于光纤通道的NVMe (NVMe/FC)、以便使用ONTAP LUN进行操作。' 
---
= 为ONTAP配置采用NVMe/FC的Windows Server 2022
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
您可以在运行Windows Server 2022的主机上配置基于光纤通道的NVMe (NVMe/FC)、以便使用ONTAP LUN进行操作。

.关于此任务
您可以对适用于Windows 2022的NVMe/FC主机配置使用以下支持。在开始配置过程之前、您还应查看已知限制。

* 提供支持：
+
从ONTAP 9.7开始、Windows Server 2022支持NVMe/FC。
